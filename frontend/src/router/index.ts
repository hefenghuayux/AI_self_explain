...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/questions", name: "question-list", component: QuestionListView, meta: { teacherOnly: true } },
...
router.beforeEach(async (to) => {
  ...
  if (to.meta.teacherOnly && authUser.value?.role !== "TEACHER") return { name: "health" }
  return true
})
